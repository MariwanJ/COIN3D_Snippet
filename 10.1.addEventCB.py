...
def myKeyPressCB(selection, eventCB):
    ...
    if coin.SoKeyboardEvent_isKeyPressEvent(event, coin.SoKeyboardEvent.UP_ARROW):
        myScaleSelection(selection, 1.1)
        eventCB.setHandled()
    elif coin.SoKeyboardEvent_isKeyPressEvent(event, coin.SoKeyboardEvent.DOWN_ARROW):
